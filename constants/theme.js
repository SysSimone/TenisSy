...
export const FONTS = {
    ...
    navTitle: { fontFamily: "Roboto_100Thin", fontSize: SIZES.navTitle },
    largeTitleBold: { fontFamily: "Roboto_400Regular", fontSize: SIZES.h2 },
    h1: { fontFamily: "Roboto_400Regular", fontSize: SIZES.h1, lineHeight: 36 },
    ...
    h4: { fontFamily: "Roboto_400Regular", fontSize: SIZES.h4, lineHeight: 22 },
    h5: { fontFamily: "Roboto_400Regular", fontSize: SIZES.h5, lineHeight: 22 },
